...
public class PhotonAlignCommand extends Command{
    ...
    public PhotonAlignCommand(PhotonCamera m_PhotonCamera, SwerveSubsystem m_SwerveSubsystem, Supplier<Pose2d> pose2d, DoubleSupplier m_vX, DoubleSupplier m_vY) {
        ...
        this.vX = m_vX;
        this.vY = m_vY;
        this.swerveController = driveBase.getSwerveController();
        ...
        if (photonResults.hasTargets()) {
            ...
            if (targetOpt.isPresent()) {
                ...
                if (!target.equals(lastTarget)) {
                    ...
                    var transform = new Transform2d(camToTarget.getTranslation().toTranslation2d(), camToTarget.getRotation().toRotation2d().minus(Rotation2d.fromDegrees(180)));
